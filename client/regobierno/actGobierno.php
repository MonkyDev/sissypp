...
<div class="responsive">
  ...
  <section id="one" style="margin-top:-20px;">
        ...
        <center>
          <P>
            <font size="+2">
              ...
              DIRECCIÓN DE EDUCACIÓN SUPERIOR E<p>
              INVESTIGACIÓN CIENTIFICA<p>
    ...
    <section id="two" style="margin-top:-40px;">
        <section id="boxO">
     ...
     <section id="tree" style="margin-top:-20px;">
     	 <section id="boxO">
            ...
            <table class="form_Gobi">
             <font face="Arial, Helvetica, sans-serif">
              <div class="TC" style="position:relative; margin-top:40px;">
              	1.1.-No. DE CONTROL:  
                <input type="text" value="<?php echo $user; ?>" id="control" style="width:200px;" readonly/>
              </div>
              <div class="TC" style="position:relative;">
              	1.2.-PERIODO DEL REPORTE PRESENTADO:  
               fecha inicio<input type="date" id="f_inicial" onblur="periodoG()" 
              ...
              <div class="TC" style="position:relative;">
              	1.4.-CARRERA:  
                <input type="text" value="<?php echo $row['carNombre']; ?>" style="width:946px;" readonly/>
              </div>
              <div class="TC" style="position:relative;">
              	1.5.-DEPENDENCIA ASIGNADA:  
                <input type="text" value="<?php echo $row['nomEmp']; ?>" class="em" style="width:808px;" readonly/>
              </div>
              <div class="TC" style="position:relative;">
              1.6.-DOMICILIO DE LA DEPENDENCIA:  
              <input type="text" value="<?php echo $row['dirEmp']; ?>" style="width:749px;" readonly/>
              </div>
              ...
              <div class="TC" style="position:relative;">
              2.1.-NOMBRE:  
              <input type="text" value="<?php echo $row['prgDes']; ?>" class="no" style="width:955px;" readonly/>
              </div>
              <div class="TC" style="position:relative;">
              2.2.-PERIODO DE PRESTACIÓN:  
              <input type="text" value="<?php echo $z; ?>" class="pe" style="width:800px;" readonly/>
              </div>
              <div class="TC" style="position:relative;">
              2.3.-OBJETIVO:  
