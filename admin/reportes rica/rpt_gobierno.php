<?php
	...
	$pdf->SetFont('Arial','','14');
	$pdf->Cell(0,.7,'3.1-DETALLE MINUCIOSO DE LAS ACTIVIDADES REALIZADAS EN EL PERIODO', 0, 1, 'J');
	$pdf->Ln(.2);
	$pdf->SetFont('Arial','','12');
	...
	$pdf->SetFont('Arial','','14');
	$pdf->Cell(0,.7,'3.2-DETALLE MINUCIOSO DE LAS ACTIVIDADES REALIZADAS EN EL PERIODO', 0, 1, 'J');
	$pdf->Ln(.2);
	...
	$pdf->SetFont('Arial','','14');
	$pdf->Cell(0,.7,'3.3-DETALLE MINUCIOSO DE LAS ACTIVIDADES REALIZADAS EN EL PERIODO', 0, 1, 'J');
	$pdf->Ln(.2);
