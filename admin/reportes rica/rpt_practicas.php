<?php
	...
	$pdf->SetXY(4.6,15.7);
	$pdf->Cell(0,.5,utf8_decode($row['cargo']) . " de la empresa", 0, 0, 'J');
	...
	$pdf->SetXY('',23);
   $pdf->Cell(0,.5,utf8_decode('*Boleta de Calificaciones que Acredite haber aprobado el 70% de Créditos Educativos'), 0, 0, 'C');
	$pdf->SetXY('',23.6);
